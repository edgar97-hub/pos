...
const ProductForm = (props) => {
    ...
    useEffect(() => {
        if (singleProduct) {
            setProductValue({
                ...
                isAddProductType: singleProduct
                    ? singleProduct[0].isAddProductType
                    : false,
            });
        }
    }, []);
    ...
    const prepareFormData = () => {
        ...
        if (
            productValue.isEdit === false ||
            productValue.isAddProductType === true
        ) {
            formData.append(
                ...
                formData.append(
                    ...
                    JSON.stringify(
                        variationTypesData.map((variationType) => ({
                            ...
                            code: `${productValue.code}-${toUpper(
                                variations
                                    .filter(
                                        (variation) =>
                                            variation.id ===
    ...
    const onSubmit = (event) => {
        ...
        if (
            ...
            console.log("singleProduct", prepareFormData());
            return;

            if (singleProduct.product_type === null) {
                if (!disabled) {
            ...
            <div className="card-body">
                <Form>
                    <div className="row">
                        ...
                        {(productValue.isAddProductType || !singleProduct) && (
                            <div className="row border-top pt-4">
                                <div className="col-md-4 mb-3">
                                    {productValue.isAddProductType ||
                                    !singleProduct ? (
                                        <ReactSelect
                                            title={getFormattedMessage(
                                                "product.type.label"
